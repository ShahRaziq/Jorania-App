  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
        ...
        children:  <TextSpan>[
            TextSpan(text: 'Tiada Sambungan ',style:TextStyle(
              fontSize: 20.sp,
              fontWeight: FontWeight.bold,
              color: Colors.purple,
            )),
            TextSpan(text: 'Internet!',style:TextStyle(
              fontSize: 30.sp,
              fontWeight: FontWeight.bold,
              color: Color.fromARGB(255,133,123,124),
            )),
            TextSpan(text: ' Sila pastikan anda mempunyai sambungan ',style:TextStyle(
              fontSize: 20.sp,
              fontWeight: FontWeight.bold,
              color: Colors.purple,
            )),
